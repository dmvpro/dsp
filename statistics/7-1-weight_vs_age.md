...
1) The scatterplot does not show a relationship between birth
weight and mother's age.

2) The correlation values are:
Pearson's is  0.0688339703541
Spearman's is 0.0946100410966
Spearman's +38% difference supports the finding in Conclusion (1).

3) The younger the mother's age had the most effect on birth weight
until age 25.
"""
```
